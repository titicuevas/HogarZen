...
import { Plus, LogOut, User, Calendar, RefreshCw, Sun, Moon, BarChart3, Settings, Home, Clock, TrendingUp, Award, Target, Sparkles } from 'lucide-react'
...
import { AIChecklistAssistant } from '../ai/AIChecklistAssistant'
...
export const Dashboard: React.FC = () => {
  ...
  const handleGenerateTasks = (tasks: any[]) => {
    // Aquí se procesarían las tareas generadas por la IA
    console.log('Tareas generadas por IA:', tasks)
    showNotification('success', `${tasks.length} tareas generadas exitosamente`)
    // TODO: Implementar la lógica para agregar las tareas al sistema
  }
    ...
    <div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        {currentView === 'dashboard' && (
          <>
            {/* Mostrar estado vacío si el usuario no tiene tareas */}
            {summary.total === 0 && !loading ? (
              <EmptyState
                onAddFirstTask={() => setShowAddModal(true)}
